                    ...
                    <div class="flex flex-col lg:flex-row gap-10">
                        ...
                        <div class="w-full lg:w-1/3 flex flex-col">
                            ...
                            <div class="mb-6">
                                ...
                                <label for="edit_product_image"
                                    ...
                                    <img id="edit_product_image_preview" src="#" alt="Preview"
                                        class="absolute inset-0 w-full h-full object-cover z-0 hidden">

                                    <!-- Lớp phủ khi hover -->
                                    <div id="edit_product_image_overlay"
                                    ...
                                    <!-- Input File ẩn -->
                                    <input type="file" name="image" id="edit_product_image" class="hidden"
                                        accept="image/png, image/jpeg, image/jpg, image/webp"
                                        onchange="previewEditProductImage(this)">
                                </label>
                                <p id="edit_product_image_error" class="text-red-500 text-xs mt-1.5 hidden mb-3"></p>
                            </div>
                            ...
                            <div>
                                ...
                                <!-- Grid Gallery -->
                                <div class="grid grid-cols-3 sm:grid-cols-4 gap-3" id="edit_product_gallery_grid">
                                    <!-- Nút Thêm Ảnh (+) -->
                                    <label for="edit_product_gallery"
                                ...
                                <input type="file" name="gallery[]" id="edit_product_gallery" multiple class="hidden"
                                    accept="image/png, image/jpeg, image/jpg, image/webp"
                                    onchange="previewEditProductGallery(this)">
                                <p id="edit_product_gallery_error" class="text-red-500 text-xs mt-1.5 hidden mb-3"></p>
                            </div>
                        ...
                        <div class="w-full lg:w-2/3 flex flex-col justify-between">
                            ...
                            <div class="space-y-6">
                                ...
                                <div>
                                    ...
                                    <div class="flex items-center gap-6">
                                        ...
                                        <label class="flex items-center gap-2 cursor-pointer group">
                                            <input type="radio" name="is_active" value="0" id="edit_product_active_0"
                            ...
                            <div class="flex justify-end items-center gap-4 mt-8 pt-6 border-t border-gray-100">
                                ...
                                <button type="submit" id="edit_product_submit_btn"
